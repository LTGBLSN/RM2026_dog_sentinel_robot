...
#define CHASSIS_3508_SPEED_PID_KI_MAX   0.0f
...
#define CHASSIS_FOLLOW_GIMBAL_PID_OUT_MAX   2000.0f
...
#define CHASSIS_MAX_VX_SPEED 2.0f //底盘最大移动速度，单位米每秒
#define CHASSIS_MAX_VY_SPEED 2.0f //底盘最大移动速度，单位米每秒
